...
CBBA Phase 2 — Consensus (repeat until stable):
  ...
  Convergence guaranteed in O(network diameter) rounds</div>
    ...
    <p>The Office of Naval Research (ONR) LOCUST (Low-Cost UAV Swarming Technology) program demonstrated <strong>31 Coyote UAVs tube-launched in 40 seconds</strong> from a naval vessel in June 2016. The Coyote (BAE Systems) launches from a standard 5-inch naval gun launcher, unfolds its wings, and autonomously joins the swarm. ONR awarded Raytheon a $29.7M development contract in 2018. LOCUST capabilities were absorbed into the broader "Super Swarm" mission by ~2021.</p>
