...
<div class="fade-in">
    ...
    <div class="interactive-panel bg-[#0d1320] border-slate-700">
        ...
        <ol class="list-decimal pl-6 space-y-4 text-slate-300 text-sm">
            ...
            <li><strong>Pre-integration:</strong> Between camera frames processed by VIO (which happen at ~30Hz, decimated from the raw 60Hz sensor feed), the IMU has fired ~13 times (at 400Hz). We integrate those IMU readings into a single "motion guess".</li>
