...
Augmented PN (APN): a_cmd = N*V_c*lambda_dot + (N/2)*a_target_perp
  ...
  Reduces miss distance from ~5 m to ~0.3 m vs step-maneuver target (Zarchan 2012).
    ...
    <figure class="my-6">
        <img src="images/m14_switchblade300.jpg" alt="AeroVironment Switchblade 300 in flight during U.S. Marine Corps exercise" class="rounded-lg w-full">
    ...
    <figure class="my-6">
        <img src="images/m14_switchblade600.jpg" alt="Switchblade 600 LASSO system with U.S. Army soldiers" class="rounded-lg w-full">
